...
// gameStart = document.getElementById("completeToken");
// let colors=['red','blue','green','yellow'];
// for (let i = 0; i < 4; i++) {
//   for(let j=0;j<4;j++){
//     const id=`[piceid="`+(colors[i]+j)+`"]`;
...
// let element = document.querySelector(`[piceid="red1"]`);
...
const setPlayerTurn = async (playerTurnIndex) => {
  ...
  elements.forEach((el) => {
    if(currentTeamTurn==='yellow')
      el.style.background="rgb(233, 233, 23)";
    else
